...
function toggleMode() {
    if (lightMode === false) {
        ...
        document.getElementById("linkedin-text2").style.color = "rgb(31, 32, 40)"
        ...
        document.getElementById("contact-section").style.color = "rgb(31, 32, 40)"
        document.getElementById("tools-section").style.color = "rgb(31, 32, 40)" 
        ...
        document.getElementById("linkedin-text2").style.color = "rgb(240, 238, 244)"
        ...
        document.getElementById("contact-section").style.color = "rgb(240, 238, 244)"
        document.getElementById("tools-section").style.color = "rgb(240, 238, 244)"
...
function showButtons5() {
    document.getElementById(`img-button-m`).style.opacity = "1"
    document.getElementById(`img-button-n`).style.opacity = "1"
    document.getElementById(`project-img5`).style.opacity = "0.15"
    document.getElementById(`made-with5`).style.opacity = "1"
}

function hideButtons5() {
    document.getElementById("img-button-m").style.opacity = "0"
